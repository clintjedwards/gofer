...
func (api *APIContext) startExtension(extension models.ExtensionRegistration, tlsCert, tlsKey string) error {
...
func (api *APIContext) startExtensions() error {
...
func (api *APIContext) stopExtensions() {
...
func (api *APIContext) restoreExtensionSubscriptions() error {
...
func (api *APIContext) collectLogs(containerID string) {
