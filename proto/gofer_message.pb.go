...
var file_gofer_message_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38,
	0x01, 0x22, 0xbe, 0x01, 0x0a, 0x15, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x54, 0x72,
	...
	0x38, 0x01, 0x22, 0x97, 0x02, 0x0a, 0x07, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x12, 0x12,
	...
	0x03, 0x75, 0x72, 0x6c, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x63, 0x68, 0x65,
	...
	0x64, 0x12, 0x2a, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x57, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0b, 0x0a, 0x07,
	...
	0x0b, 0x0a, 0x07, 0x53, 0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x10, 0x05, 0x22, 0x8e, 0x02, 0x0a,
...
var file_gofer_message_proto_goTypes = []interface{}{
	...
	(*TriggerEvent)(nil),          // 17: proto.TriggerEvent
	(*PipelineTriggerConfig)(nil), // 18: proto.PipelineTriggerConfig
	(*Trigger)(nil),               // 19: proto.Trigger
	(*Token)(nil),                 // 20: proto.Token
	(*Namespace)(nil),             // 21: proto.Namespace
	...
	nil,                           // 26: proto.Run.VariablesEntry
	nil,                           // 27: proto.TriggerEvent.MetadataEntry
	nil,                           // 28: proto.PipelineTriggerConfig.ConfigEntry
	nil,                           // 29: proto.Token.MetadataEntry
}
var file_gofer_message_proto_depIdxs = []int32{
	...
	26, // 7: proto.Run.variables:type_name -> proto.Run.VariablesEntry
	...
	16, // 14: proto.TriggerEvent.result:type_name -> proto.TriggerResult
	27, // 15: proto.TriggerEvent.metadata:type_name -> proto.TriggerEvent.MetadataEntry
	28, // 16: proto.PipelineTriggerConfig.config:type_name -> proto.PipelineTriggerConfig.ConfigEntry
	7,  // 17: proto.Trigger.state:type_name -> proto.Trigger.State
	8,  // 18: proto.Token.kind:type_name -> proto.Token.Kind
	29, // 19: proto.Token.metadata:type_name -> proto.Token.MetadataEntry
	10, // 20: proto.Pipeline.TasksEntry.value:type_name -> proto.Task
	18, // 21: proto.Pipeline.TriggersEntry.value:type_name -> proto.PipelineTriggerConfig
	0,  // 22: proto.Task.DependsOnEntry.value:type_name -> proto.TaskRequiredParentState
