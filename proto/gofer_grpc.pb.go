...
func (c *goferClient) GetTriggerEvent(ctx context.Context, in *GetTriggerEventRequest, opts ...grpc.CallOption) (*GetTriggerEventResponse, error) {
	out := new(GetTriggerEventResponse)
	err := c.cc.Invoke(ctx, "/proto.Gofer/GetTriggerEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goferClient) BatchGetTriggerEvents(ctx context.Context, in *BatchGetTriggerEventsRequest, opts ...grpc.CallOption) (*BatchGetTriggerEventsResponse, error) {
	out := new(BatchGetTriggerEventsResponse)
	err := c.cc.Invoke(ctx, "/proto.Gofer/BatchGetTriggerEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goferClient) ListTriggerEvents(ctx context.Context, in *ListTriggerEventsRequest, opts ...grpc.CallOption) (*ListTriggerEventsResponse, error) {
	out := new(ListTriggerEventsResponse)
	err := c.cc.Invoke(ctx, "/proto.Gofer/ListTriggerEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goferClient) GetTaskRunLogs(ctx context.Context, in *GetTaskRunLogsRequest, opts ...grpc.CallOption) (Gofer_GetTaskRunLogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Gofer_serviceDesc.Streams[0], "/proto.Gofer/GetTaskRunLogs", opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedGoferServer) GetTriggerEvent(context.Context, *GetTriggerEventRequest) (*GetTriggerEventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTriggerEvent not implemented")
}
func (UnimplementedGoferServer) BatchGetTriggerEvents(context.Context, *BatchGetTriggerEventsRequest) (*BatchGetTriggerEventsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchGetTriggerEvents not implemented")
}
...
func RegisterGoferServer(s grpc.ServiceRegistrar, srv GoferServer) {
	s.RegisterService(&_Gofer_serviceDesc, srv)
}
...
func _Gofer_GetTriggerEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTriggerEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoferServer).GetTriggerEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Gofer/GetTriggerEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoferServer).GetTriggerEvent(ctx, req.(*GetTriggerEventRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Gofer_BatchGetTriggerEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchGetTriggerEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoferServer).BatchGetTriggerEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Gofer/BatchGetTriggerEvents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoferServer).BatchGetTriggerEvents(ctx, req.(*BatchGetTriggerEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Gofer_ListTriggerEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTriggerEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoferServer).ListTriggerEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Gofer/ListTriggerEvents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoferServer).ListTriggerEvents(ctx, req.(*ListTriggerEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Gofer_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTriggerEvent",
			Handler:    _Gofer_GetTriggerEvent_Handler,
		},
		{
			MethodName: "BatchGetTriggerEvents",
			Handler:    _Gofer_BatchGetTriggerEvents_Handler,
		},
		{
			MethodName: "ListTriggerEvents",
			Handler:    _Gofer_ListTriggerEvents_Handler,
		},
		{
			MethodName: "GetRun",
